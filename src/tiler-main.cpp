...
main (int argc, char *argv[])
{
  ...
  QCoreApplication::setApplicationName ("tiler");
  deliberate::ProgramVersion pv ("Tiler");
  ...
  deliberate::CmdOptions  opts ("tiler");
  ...
  app.setWindowIcon (tiler.windowIcon());
  tiler.Init (app);
  tiler.AddConfigMessages (configMessages);
